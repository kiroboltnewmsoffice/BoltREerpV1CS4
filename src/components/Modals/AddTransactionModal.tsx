...
import { X, DollarSign, User, CreditCard, Calendar } from 'lucide-react';
...
const AddTransactionModal: React.FC<AddTransactionModalProps> = ({ isOpen, onClose }) => {
  const { addTransaction, customers, units } = useDataStore();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const transactionData = {
      ...
      attachments: [],
      chequeDetails: formData.paymentMethod === 'cheque' ? {
  ...
  const handleCancel = () => {
    console.log('Cancelling add transaction');
    onClose();
  };
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {formData.paymentMethod === 'cheque' && (
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 space-y-4">
              <h3 className="text-lg font-medium text-gray-900 dark:text-white">Cheque Details</h3>
